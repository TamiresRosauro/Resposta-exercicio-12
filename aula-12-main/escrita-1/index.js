...
function informacoesSobreCaio (nome, idade, cidade, profissao){
...
informacoesSobreCaio = (Caio, 23, Sao Paulo, estudante)


/**B */

function informacoesSobreMim (nome,idade, cidade, profissao){
...
informacoesSobreMim = (Tamires, 33, Sao Leopoldo, estudante)

function informacoesSobreAlguem (nome,idade, cidade, profissao){
...
informacoesSobreAlguem = (Alguem, 30, Sao Leopoldo, estudante)
